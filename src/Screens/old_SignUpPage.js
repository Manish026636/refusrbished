  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <div className="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-3 py-5">
          <div
            className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden border-gray-500 border"
            style={{ maxWidth: 1000 }}
          >
            <div className="md:flex w-full">
              <div className="hidden md:block w-1/2 bg-indigo-500 pt-10 pb-5 px-10">
                <svg
              ...
              <div className="w-full md:w-1/2 py-10 px-3 md:px-10">
                <form>
                  ...
                  <div>
                    <div className="flex -mx-3">
                      <div className="w-1/2 px-3 mb-5 h-full">
                        ...
                        <div className="flex">
                          ...
                          <input
                            type="text"
                            className={`w-full -ml-10 pl-10 pr-3 p-2.5 rounded-lg border-2 outline-blue-gray-500 text-black bg-gray-50 ${
                      ...
                      <div className="w-full px-3 mb-5">
                        ...
                        <div className="flex">
                          ...
                          <input
                            type="number"
                            maxLength={10}
                            className={`w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-blue-gray-500 text-black bg-gray-50 placeholder-gray-700 ${
                              error?.phone
                                ? "border-red-500"
                                : "border-gray-500"
                            }`}
                    ...
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-5">
                        ...
                        <div className="flex">
                          <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center text-black"></div>
                          <ReactFlagsSelect
                            className={`w-full h-full  -ml-10 -pt-3 p-0  focus:ring-2 focus:ring-blue-gray-900 focus:border-black  focus:ring-offset-2  outline-blue-500 text-black bg-gray-50 placeholder-gray-700 ${
                              error?.country
                                ? "border-red-500"
                                : "border-gray-500"
                            }`}
                      ...
                      <div className="w-full px-3 mb-3">
                        ...
                        <div className="flex flex-col md:flex-row justify-center items-center">
                          {captchaLoading ? (
                            ...
                            captcha_text && (
                              <div className="flex flex-row justify-around items-center flex-1 mr-2 w-1/2 lg:w1/3">
                                <img
                                  className="h-14"
                                  src={captcha_text}
                                  alt="Captcha"
                    ...
                    <div className="flex flex-col-reverse md:flex-row items-center justify-center">
                      <Link
                        className="flex justify-center items-center w-full md:w-[30%] my-2 md:my-0"
                        to="/"
                      >
                        <Button
                          className="flex items-center justify-center w-full px-3 py-[0.7rem] font-semibold"
                          variant="text"
                          color="indigo"
                        >
                      ...
                      <div className="w-full md:w-[70%] md:ml-4 my-auto">
                        <button
                          className="flex items-center justify-center w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"
