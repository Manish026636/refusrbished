...
import {
  getMCAUSSpeakerData,
  putMCAUSDeleagateSpeakerInfo,
} from "../../../../../actions/MCAUSActions";
import { showErrors } from "../../../Utilities/errorShow";

const Feedback = ({
  handleMCAUSInfoCloseModal,
  passedVotingTopicId,
  isCurrentMCAUSSpeakerId,
}) => {
  ...
  const handleSubmit = (event) => {
    ...
    const MCAUSSpeakerRawData = {
      ...
      poi: poi,
      notes: notes,
      speaker: isCurrentMCAUSSpeakerId,
    };
    if (
      openingStatements > 10 ||
      closingStatements > 10 ||
      foreignPolicy > 10 ||
      marksOnCheat > 10 ||
      poi > 10
    ) {
    ...
    dispatch(putMCAUSDeleagateSpeakerInfo(MCAUSSpeakerRawData));
    handleMCAUSInfoCloseModal();
      ...
      <div className="border border-teal-500  modal-container bg-white w-11/12 md:max-w-md mx-auto rounded-lg shadow-lg z-50 overflow-y-auto">
        <div className="modal-content py-4 text-left px-6">
          ...
          <div className="flex justify-end pt-2">
            <button
              onClick={handleMCAUSInfoCloseModal}
            ...
            <button
              ...
              className="focus:outline-none px-4 bg-teal-500 p-3 ml-3 rounded-lg text-white hover:bg-teal-400 transition-all"
            >
              Submit
            </button>
          </div>
